...
{
    // THIS IS NOT MY CODE: Code from http://stackoverflow.com/a/3806407
    ...
    public sealed class DynamicJsonConverter : JavaScriptConverter
    {
        ...
        private sealed class DynamicJsonObject : DynamicObject
        {
            ...
            {
                var objectDictionary = objResult as IDictionary<string, object>;
                if (objectDictionary != null)
                {
                    return new DynamicJsonObject(objectDictionary);
                }
